...
def test_lucas_float_numbers():
    with pytest.raises(TypeError):
        lucas(3.999), "Test numbers should be whole numbers"


def test_fibonacci_float_numbers():
    with pytest.raises(TypeError):
        fibonacci(4.5), "Test numbers should be whole numbers"
        fibonacci2(9.9), "Test numbers should be whole numbers"
